...
using Hoyo.EventBus.Extensions;
...
{
    const string BROKER_NAME = "hoyo.event.bus";
    ...
    public EventBusRabbitMQ(IServiceProvider serviceProvider, IRabbitMQPersistentConnection persistentConnection, ILogger<EventBusRabbitMQ> logger, IEventBusSubscriptionsManager subsManager, string? queueName = null, int retryCount = 5)
    {
    ...
    public void Publish(string eventName, IntegrationEvent @event)
    {
    ...
    private void StartBasicConsume()
    {
        ...
        if (_consumerChannel != null)
        {
            ...
            _ = _consumerChannel.BasicConsume(queue: _queueName, autoAck: false, consumer: consumer);
        }
    ...
    private IModel CreateConsumerChannel()
    {
        ...
        channel.ExchangeDeclare(exchange: BROKER_NAME, type: ExchangeType.Direct);
        _ = channel.QueueDeclare(queue: _queueName, durable: true, exclusive: false, autoDelete: false, arguments: null);
