...
public static class DateTimeStampExtension
{
    ...
    /// <returns></returns>
    public static DateTime ToDateTime(this long timestamp) => new DateTime(1970, 1, 1).ToLocalTime().AddSeconds(timestamp / 1000d);
    ...
    /// <returns></returns>
    public static long ToUnixTimeStamp_13bit(this DateTime time) => (long)((time - new DateTime(1970, 1, 1).ToLocalTime()).TotalSeconds * 1000);
